...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void mostrarUbicacion(Ubicacion ubicacion){
        LatLng ubiciacion = new LatLng(ubicacion.getLat(), ubicacion.getLang());
        mMap.addMarker(new MarkerOptions().position(ubiciacion).title(ubicacion.getNombre()));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(ubiciacion));
    }
